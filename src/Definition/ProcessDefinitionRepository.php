...
use Yummuu\Workflower\Workflow\ProcessDefinitionInterface;
use Yummuu\Workflower\Workflow\ProcessDefinitionRepositoryInterface;
...
class ProcessDefinitionRepository implements ProcessDefinitionRepositoryInterface
{
     ...
     * @param string $source
     */
    public function importFromSource(string $source, $data = [])
    {
        $import = new Bpmn2Reader();

        $definitions = $import->readSource($source, $data);
